...
save_path = "Data-UR/UR_new-pose+score.csv"

annot_file = "Data-UR/urfall-cam0-falls.csv"  # from create_dataset_1.py
video_folder = "Fall_sequences"
annot_folder = "Data-UR/falldata/urfall/Annotation_files"  # bounding box annotation for each frame.
...
for vid in vid_list:
    ...
    while True:
        ...
        if ret:
            ...
            cls_idx = int(frames_label[frames_label["frame"] == i].iloc[0]["label"])
            ...
            frame = cv2.putText(
                frame,
                "Frame: {}, Pose: {}, Score: {:.4f}".format(i, cls_idx, scr),
                (10, 20),
